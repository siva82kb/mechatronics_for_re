...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figure/fig02-07a.pdf}
        \caption{Ideal voltage source}
        \label{fig:02-07a}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figure/fig02-07b.pdf}
        \caption{Practical voltage source with a load}
        \label{fig:02-07b}
    \end{subfigure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figure/fig02-08.pdf}
...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{figure/ex02-01.pdf}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{figure/ex02-02.pdf}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.65\textwidth]{figure/ex02-03.pdf}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.35\textwidth]{figure/ex02-04.pdf}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.35\textwidth]{figure/ex02-05.pdf}
        \caption{[Exercise 5]Find the equivalent impedance of the circuit.}
        \label{fig:ex02-05}
    \end{figure}
\end{enumerate}